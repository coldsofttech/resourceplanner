...
CONFIGURATION_DEFAULTS = {
    ...
    "PROJECT_APPROVAL_INFO_CONTACTS": {
    ...
    "PROJECT_APPROVAL_FINOPS_CONTACTS": {
    ...
    "PROJECT_APPROVAL_NO_CHARGE_TYPES": {
    ...
    "PROJECT_APPROVAL_RECHARGE_CONTACT_ROLES": {
