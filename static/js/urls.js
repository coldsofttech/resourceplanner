...
export const API_URLS = {
    ...
    monthly_wins: {
        ...
        previewTeams:          (pk) => ({ method: 'GET',    href: `${API_BASE}monthly-wins/${pk}/preview-teams/` }),
        previewSurvey:         (pk, phase, teamId) => ({ method: 'GET', href: `${API_BASE}monthly-wins/${pk}/preview-survey/?phase=${phase}${teamId ? '&team_id=' + teamId : ''}` }),
        surveyDataForAdmin:    (surveyPk) => ({ method: 'GET',  href: `${API_BASE}monthly-wins/surveys/${surveyPk}/survey-data/` }),
        overrideSubmit:        (surveyPk) => ({ method: 'POST', href: `${API_BASE}monthly-wins/surveys/${surveyPk}/override-submit/` }),
    ...
    custom_reports: {
        dataSources: { method: 'GET',  href: `${API_BASE}custom-reports/data-sources/` },
        list:        { method: 'GET',  href: `${API_BASE}custom-reports/` },
        create:      { method: 'POST', href: `${API_BASE}custom-reports/` },
        detail:      (pk) => ({ method: 'GET',    href: `${API_BASE}custom-reports/${pk}/` }),
        update:      (pk) => ({ method: 'PATCH',  href: `${API_BASE}custom-reports/${pk}/` }),
        delete:      (pk) => ({ method: 'DELETE', href: `${API_BASE}custom-reports/${pk}/` }),
        preview:     { method: 'POST', href: `${API_BASE}custom-reports/preview/` },
        execute:     (pk) => ({ method: 'POST',   href: `${API_BASE}custom-reports/${pk}/execute/` }),
        export:      (pk, fmt) => ({ method: 'GET', href: `${API_BASE}custom-reports/${pk}/export/?fmt=${fmt}` }),
        share:       (pk) => ({ method: 'POST',   href: `${API_BASE}custom-reports/${pk}/share/` }),
        unshare:     (pk, userId) => ({ method: 'DELETE', href: `${API_BASE}custom-reports/${pk}/share/${userId}/` }),
    },
    integrations: {
